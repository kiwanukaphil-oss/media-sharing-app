...
This is a locally verified prerequisite, **not a complete write freeze**. Already-issued direct upload URLs, in-flight R2 requests, publication jobs, other metadata routes and independent backup writers still require coordinated fencing and reconciliation before physical erasure. Deployment evidence is recorded separately in the roadmap.
