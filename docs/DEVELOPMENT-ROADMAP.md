...
- [ ] User completes the password change, then verify old-session revocation before fresh login, new sign-in, provider logout and inbox authentication. General activation and personal allocation remain closed pending release gates.
