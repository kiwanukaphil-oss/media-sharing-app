...
| 3 | Useful collaboration and upload requests | In progress | 1/6 | Verified identity/access foundation; general release gates remain |
...
- [ ] Release role-aware invitation creation, recipient previews and immutable accepted grants after local/hosted verification and the additive migration. Migration 0020 is not yet applied remotely.
