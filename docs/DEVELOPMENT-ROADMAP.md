...
- [ ] Provider handoff: Auth0 dashboard session expired. User must sign in in the open dashboard tab; a focused request is pending. The separate recovery-email authorisation remains unanswered. No new email was sent, no live access changed and no production deployment occurred.
