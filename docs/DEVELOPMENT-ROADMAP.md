...
- [ ] Verify trusted-browser persistence after explicit user permission. General activation and personal allocation remain closed pending release gates.
