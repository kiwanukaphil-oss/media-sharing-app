...
- [ ] Complete and independently restore the pre-release backup, deploy with account sign-in disabled, then activate only the designated-account pilot. General activation and personal allocation remain closed pending release gates.
