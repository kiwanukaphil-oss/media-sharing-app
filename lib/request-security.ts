...
export async function limitDeviceRequest(request: Request, deviceId: string, resource: string, id?: string, action?: string) {
  ...
  if (request.method !== "GET" && (createsUpload || resource === "invitations" || resource === "person-invitations" || resource === "people" || resource === "favorites" || resource === "metadata-export" || resource === "import-layout" || resource === "access-scopes" || resource === "scope-copies" || resource === "intake" || resource === "upload-requests" || resource === "delivery" || resource === "deliveries" || resource === "publications" || request.method === "DELETE")) {
