...
export async function limitDeviceRequest(request: Request, deviceId: string, resource: string, id?: string, action?: string) {
  ...
  if (request.method !== "GET" && (createsUpload || resource === "invitations" || resource === "person-invitations" || resource === "people" || resource === "favorites" || resource === "metadata-export" || resource === "publications" || request.method === "DELETE")) {
