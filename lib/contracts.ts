...
export type Session = { space: { id: string; name: string; kind?: "personal" | "shared" }; deviceId: string; role: DeviceRole; transport: "local" | "direct" | "unconfigured"; authentication?: "account"; personId?: string };
