...
export type LibraryRole = DeviceRole | "editor";
export function libraryRoleLabel(role: string) { return role === "owner" ? "Owner" : role === "editor" ? "Editor" : role === "member" ? "Member" : "Unavailable"; }
