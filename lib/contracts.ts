...
export type Session = { space: { id: string; name: string }; deviceId: string; role: DeviceRole; transport: "local" | "direct" | "unconfigured"; authentication?: "account"; personId?: string };
